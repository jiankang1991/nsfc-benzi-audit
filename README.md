...
<p align="center">
  ...
  <img alt="Calibrated: 79" src="https://img.shields.io/badge/Calibrated-79-4f46e5?style=flat-square&labelColor=0B0A1A">
</p>
...
- 想检查年度计划和预期成果：进度有没有把查文献、预试验、结题撰文当成研究任务；成果有没有按科学问题拆分，还是只有论文数、专利数、学生数。
- 想检查预算说明与研究任务是否对得上：哪些科目挂不到任何研究内容，哪条研究内容没有经费支撑，哪些数字没有测算依据。
- 改完一轮后想复审：把上一轮报告和新稿一起给 Agent，逐条判定“必改”项是已改、未改，还是改动无效。
...
| 撞题与代码路由 | 创新点：现有方法在……方面存在不足，本项目首次提出…… | 创新点：相对已资助的[具体方向/批准号]，本项目新增[变量/约束/适用边界]；申请代码由[X]校准为[Y] | 在基金委知识管理门户按“题目里会出现的词”逐年检索同类已资助/已结题项目，把创新点里泛指的“现有方法”换成有批准号的具体近邻；再用命中项目的申请代码分布校准自己的代码选择。注意最近三四年的项目落在结题库盲区里，查不到不等于没人做。 |
